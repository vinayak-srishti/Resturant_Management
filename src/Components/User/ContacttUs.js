  ...
  return (
    <div>
      ...
      <div className="contact-info">
        <h3 id="c-i">Contact Info</h3>
        <h3 id="phone">
          <FiPhoneCall style={{ marginRight: "25px" }} />
          Phone
        </h3>
        <p style={{ color: "whitesmoke", marginLeft: "70px" }}>
          +91 9876543210
        </p>
        <h3 id="location">
        ...
        <form className="opening-hours">
          ...
          <h5 id="opening-days">Monday-Friday Saturday-Sunday</h5>
          <p id="opening-time">10AM-12PM CLOSED</p>
...
<form onSubmit={onsubmitdata}>
        <div className="contact-form">
          ...
          >
            ...
            <button style={{height:'50px',width:'145px',position:'absolute',bottom:'-5rem',left:'0.8rem'}} type="button" class="btn btn-danger">Send message</button>
          </div>
        </div>
        </form>
      </div>
